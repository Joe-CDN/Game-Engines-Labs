...
public class MessagePanelBehavior : MonoBehaviour
{
    ...
    private void OnEnable() {
        ...
        Pickup.pickUpFifty += Pickup_pickUpFifty;
        Pickup.pickUpHundred += Pickup_pickUpHundred;        
    }
    ...
    private void Pickup_pickUpFifty(string obj)
    {
        messageDisplay.text = obj;
    }
    private void Pickup_pickUpHundred(string obj)
    {
        messageDisplay.text = obj;
    }
